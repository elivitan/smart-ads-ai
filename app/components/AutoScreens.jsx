...
export function AutoLaunchingScreen({ cancelRef, setAutoLaunching, setShowDashboard, StyleTag }) {
  return (
...
export function AutoStatusScreen({ autoStatus, setAutoStatus, showConfetti, navigate, StyleTag }) {
  return (
    <div className="sr dk"><StyleTag/>
